...
if(isset($_POST['submit'])){
	...
	$obj=new DbFunction();
	$obj->create_studends_group($_POST['course-short'],$_POST['course-full'],$_POST['cdate']);
...
<!--nav-->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Add student groups</div>
							...
							<div class="row">
						 	<div class="col-lg-10">
										...
										<div class="form-group">
											<div class="col-lg-4">
					 <label>Programme full Name<span id="" style="font-size:11px;color:red">*</span>	</label>
											</div>
											<div class="col-lg-6">
  ...
  <input class="form-control" name="course-short" id="cshort" required="required"  onblur="courseAvailability()">       
		...
		<div class="form-group">
		<div class="col-lg-4">
		<label>Group no (ID)<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
	...
	<div class="form-group">
	<div class="col-lg-4">
	 <label>Creation Date (Acadamic year)</label>
	</div>
	<div class="col-lg-6">
	<input class="form-control" value="<?php echo date('d-m-Y');?>" readonly="readonly" name="cdate">
		...
		<br><br>		
							...
							<input type="submit" class="btn btn-primary" name="submit" value="Create Group"></button>
											</div>
